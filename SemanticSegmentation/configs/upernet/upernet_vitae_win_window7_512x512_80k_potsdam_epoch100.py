...
model = dict(
    type='EncoderDecoder',
    pretrained=
    '/media/root/9E46A26D46A2463D/ViTAE-Transformer-Remote-Sensing/SemanticSegmentation/model/upernet-rsp-vitaev2-s-potsdam-latest.pth',
    backbone=dict(
...
data_root = '/root/PycharmProjects/xmx/data/potsdam'
img_norm_cfg = dict(
